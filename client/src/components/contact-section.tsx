...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-20 bg-ranch-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-playfair font-bold text-texas-red mb-6">Plan Your Visit</h2>
          <p className="text-xl text-warm-gray max-w-3xl mx-auto leading-relaxed">
            Ready to experience all that Lampasas Legacy Ranch has to offer? Get in touch with us to start planning your event or visit.
          </p>
        </div>
            ...
            <Card className="bg-white shadow-lg mb-8">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-warm-gray">info@lampasaslegacyranch.com</span>
                </div>
              </CardContent>
            </Card>
